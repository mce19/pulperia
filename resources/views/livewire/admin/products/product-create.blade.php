    ...
    <form wire:submit="store">
            ...
            <div
                ...
                <figure class="mb-4">
                    <img class="aspect-[16/9] object-cover mx-auto rounded-md"
                        src="{{ $image ? $image->temporaryUrl() : asset('img/two-img.jpg') }}" alt="agregar imagen">
                </figure>
        ...
        <div class="card">
            ...
            <div class="mb-4">
                ...
                <x-input wire:model.defer="product.sku" class="w-full" placeholder="Ingrese el codigo del producto" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input wire:model.defer="product.name" class="w-full" placeholder="Ingrese el nombre del producto" />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-textarea wire:model.defer="product.description" class="w-full"
            ...
            <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <x-input wire:model.defer="product.price" 
                    type="number"
                    step="0.01"
                    class="w-full"
