...
class FamilySeeder extends Seeder
{
    ...
    {
        //las llaves respresentan las categorias
        $families = [
             //familia
            'Tecnología' => [ //laves representan la familia
                // categoria -> el value representan las categorias
                'Televisores' => [

                    //subcategoria -> y las categorias contiene las subcategorias
                    'Accesorios para TV',
                    'LED',
                    'OLED',
                    'Otros',
